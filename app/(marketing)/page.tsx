...
import { ArrowRight, Check, MessageSquare, FileText, Search, Shield, Globe, Zap } from "lucide-react"
      ...
      <main className="flex-1">
            ...
            <div className="flex flex-col lg:flex-row items-center">
              <div className="lg:w-1/2 lg:pr-12 mb-12 lg:mb-0">
                <div className="inline-flex items-center rounded-full border border-blue-200 bg-white px-3 py-1 text-sm text-blue-900 mb-6">
                  ...
                  Introducing Legal Lens AI
                </div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
                  Your AI-Powered <span className="text-blue-900">Legal Assistant</span>
                </h1>
                <p className="text-xl text-gray-600 mb-8 max-w-lg">
                  Access legal information, generate documents, and retrieve case law with the power of artificial
                  intelligence.
                </p>
        ...
        <section className="py-12 bg-white border-y">
          <div className="container mx-auto px-4">
            <p className="text-center text-gray-600 mb-8">Trusted by legal professionals from leading organizations</p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-xl text-gray-600">
                Legal Lens combines AI technology with legal expertise to provide you with comprehensive legal
                assistance.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-semibold mb-2">AI-Powered Legal Chat</h3>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                <div className="relative mx-auto w-16 h-16 rounded-full bg-blue-900 text-white flex items-center justify-center text-2xl font-bold mb-6">
                  1<div className="absolute w-full h-0.5 bg-blue-200 right-0 top-1/2 -z-10 md:w-full md:left-1/2"></div>
                </div>
              ...
              <div className="text-center">
                <div className="relative mx-auto w-16 h-16 rounded-full bg-blue-900 text-white flex items-center justify-center text-2xl font-bold mb-6">
                  2<div className="absolute w-full h-0.5 bg-blue-200 right-0 top-1/2 -z-10 md:w-full md:left-1/2"></div>
                </div>
                <h3 className="text-xl font-semibold mb-2">AI Processes Your Request</h3>
                <p className="text-gray-600">
                  Our advanced AI analyzes your request, searches relevant legal databases, and prepares a comprehensive
                  response.
                </p>
              </div>
